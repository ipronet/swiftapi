...
const schema = {
  ...
  email: Joi.object({
    ...
    smtpUser: Joi.string().label("Smtp User"),
    smtpPass: Joi.string().label("Smtp Pass"),
    smtpFrom: Joi.string().label("Smtp From"),
    enabled: Joi.number().label("Enable ?"),
  }),
  //update email
  Updatemail: Joi.object({
    id: Joi.string().label("ID"),
    smtpHost: Joi.string().label("Smtp Host"),
    smtpPort: Joi.number().label("Smtp Port"),
    smtpTLS: Joi.number().label("TLs"),
    smtpUser: Joi.string().label("Smtp User"),
    smtpPass: Joi.string().label("Smtp Pass"),
    smtpFrom: Joi.string().label("Smtp From"),
    enabled: Joi.number().label("Enable ?"),
  ...
  alertProfile: Joi.object({
    ...
    idFlow: Joi.any().label("Message Flow"),
    message_template: Joi.any().label("Message Template"),
    internal_alert_email: Joi.string().email().required().label("Alert Email"),
    idalert_type: Joi.any().label("Alert Type"),
    Subject: Joi.any().label("Subject"),
    Recipient: Joi.any().label("Recipient"),
